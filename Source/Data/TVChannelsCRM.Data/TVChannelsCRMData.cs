namespace TVChannelsCRM.Data
{
    ...
    public class TVChannelsCRMData : ITVChannelsCRMData
    {
        private readonly ITVChannelsCRMDbContext context;

        private readonly Dictionary<Type, object> repositories = new Dictionary<Type, object>();

        public TVChannelsCRMData(ITVChannelsCRMDbContext context)
        {
            this.context = context;
        }

        public ITVChannelsCRMDbContext Context
        {
            get
            {
                return this.context;
